...
\subsection{Interpolationspolynome verglichen mit Splines}
\begin{itemize}

	\item Oszilation/große Fehler in den Randbereichen

	\item Schlechte Kondition bei vielen Eingabewerten
	
	\item Mehr rechenaufwand bei vielen Eingabewerten
